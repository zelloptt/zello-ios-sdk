...
@interface ZCCSRDelegateController ()

@property (nonatomic, strong, readonly) dispatch_queue_t accessQueue;

@property (atomic, assign, readwrite) ZCCSRDelegateAvailableMethods availableDelegateMethods;

@end

@implementation ZCCSRDelegateController
...
- (void)setDelegate:(id<ZCCSRWebSocketDelegate> _Nullable)delegate
{
    dispatch_barrier_async(self.accessQueue, ^{
        ...
        self.availableDelegateMethods = (ZCCSRDelegateAvailableMethods){
...
{
    __block id<ZCCSRWebSocketDelegate> delegate = nil;
...
{
    __block __strong id<ZCCSRWebSocketDelegate> delegate = nil;
    __block ZCCSRDelegateAvailableMethods availableMethods = {};
    dispatch_sync(self.accessQueue, ^{

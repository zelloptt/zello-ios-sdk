...
CFHTTPMessageRef ZCCSRHTTPConnectMessageCreate(NSURLRequest *request,
                                            ...
                                            NSArray<NSString *> *_Nullable requestedProtocols)
{
    ...
    NSString *basicAuthorizationString = ZCCSRBasicAuthorizationHeaderFromURL(url);
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Origin"), (__bridge CFStringRef)ZCCSRURLOrigin(url));
